...
// Keep browser-delivered OCR dependencies and platform thresholds in one place so
// source, import maps, and docs can be reviewed together during OCR upgrades.
