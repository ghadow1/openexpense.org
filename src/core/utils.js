...
export const Utils = {
    ...
    shouldWarmOcr() {
        ...
        if (OCR_CONFIG.idleWarmup.avoidEffectiveTypes.includes(connection?.effectiveType)) return false;
        if (navigator.deviceMemory && navigator.deviceMemory < OCR_CONFIG.idleWarmup.minDeviceMemoryGb) return false;
        return true;
    },
