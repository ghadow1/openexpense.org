...
export const Utils = {
    ...
    shouldWarmOcr() {
        ...
        if (OCR_CONFIG.warmup.skipEffectiveTypes.includes(info.effectiveType)) return false;
        if (info.deviceMemory != null && info.deviceMemory < OCR_CONFIG.warmup.minDeviceMemoryGb) return false;
        return true;
    },
