...
| [`core/plan.js`](core/plan.js) | Weekly savings, spend/income bases, month reserve |
...
| [`features/dash-strip.js`](features/dash-strip.js) | Snapshot carousel: Overview, Income, Expenses, Budget |
