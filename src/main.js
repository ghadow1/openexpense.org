...
async function initApplication() {
    ...
    if (Utils.shouldWarmOcr()) {
        ...
        if (typeof requestIdleCallback === 'function') requestIdleCallback(warmOcr, { timeout: OCR_CONFIG.performance?.idleWarmupTimeoutMs || 8000 });
        else setTimeout(warmOcr, OCR_CONFIG.performance?.idleWarmupFallbackMs || 3000);
    }
