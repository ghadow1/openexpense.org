...
async function initApplication() {
    ...
    // @platform @perf @ocr-engine
    // Desktop-class sessions preload during idle. Constrained/mobile sessions
    // keep the first-load cost attached to the explicit Scan action.
