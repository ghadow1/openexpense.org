...
async function initApplication() {
    ...
    // @ocr-engine @perf
    // Opportunistic warmup improves desktop first-scan latency, but skips
    // constrained mobile/network sessions so page load stays responsive.
    if (Utils.shouldWarmOcr(OCR_CONFIG.warmup)) {
