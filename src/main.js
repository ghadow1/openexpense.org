...
async function initApplication() {
    ...
    // Desktop-class sessions warm the OCR model during idle time; constrained
    // mobile/data-saver sessions still load it on demand when the user scans.
    if (Utils.shouldWarmOcr(OCR_CONFIG)) {
        ...
        else setTimeout(warmOcr, OCR_CONFIG.warmup.delayMs);
    }
