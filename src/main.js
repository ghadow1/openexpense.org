...
async function initApplication() {
    ...
    if (Utils.shouldWarmOcr()) {
        if (typeof requestIdleCallback === 'function') requestIdleCallback(warmOcr, { timeout: OCR_CONFIG.warmup.idleTimeout });
        else setTimeout(warmOcr, OCR_CONFIG.warmup.fallbackDelay);
    }
